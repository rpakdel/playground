...
/***/ function(module, exports, __webpack_require__) {
	...
	var layout = new _layout2.default(el, new _menu2.default(), new _main2.default());
	layout.render();
	...
	var Layout = function () {
	    ...
	    (0, _createClass3.default)(Layout, [{
	        ...
	        value: function render() {
	            this.el.innerHTML = this.menu.render() + this.main.render();
	        }
	    }]);
	    return Layout;
	}();
